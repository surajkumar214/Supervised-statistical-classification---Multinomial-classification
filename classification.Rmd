...
```{r Exploratory & formal analysis , echo=FALSE, eval=TRUE, message=FALSE, warning=FALSE}
skim(car)
...
set.seed(81)
nn_car1 <- neuralnet( acc+good+unacc+vgood~.,data = trainData ,hidden = c(3,3,4) ,linear.output=FALSE,err.fct='ce')
